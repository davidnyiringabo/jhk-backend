...
exports.updateUser = async (req,res)=>{
    ...
    const updateQuery = "UPDATE users SET firstName = $1, lastName = $2, email = $3, position = $4, phone = $5 WHERE email = $3";
    const updatedUser = await client.query(updateQuery, [firstName, lastName, email, position, phone]);
